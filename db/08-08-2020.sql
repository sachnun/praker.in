...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Agu 2020 pada 13.08
...
-- Database: `prakerin`
--
CREATE DATABASE IF NOT EXISTS `prakerin` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `prakerin`;
...
INSERT INTO `akun` (`id`, `nama`, `email`, `pass`, `perusahaan`, `instansi`, `pilih`, `akses`) VALUES
(2, 'Sachnun', 'sachnun12@ymail.com', '12345', NULL, NULL, 0, 1);
